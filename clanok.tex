...
vyznmaný antropológ ktorý v svojej práci o proxemike ju definoval ako "Pozorovania a teórie % TODO Správne citovať
...
%\paragraph{Veľmi dôležitá poznámka.} % TODO remove
%Niekedy je potrebné nadpisom označiť odsek. Text pokračuje hneď za nadpisom. % TODO remove
\pagebreak
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Kultúrne dimenzie definoval holandský vedec Geert Hofstede ako "Kolektívne programovanie mysle, % TODO správne citovať
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Literatúra %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%časť~\ref{zaklad}), a potom na ešte nejaké (časť~\ref{zaklad}).\footnote{Niekedy môžete potrebovať aj poznámku pod čiarou.}Hall zdôrazdňoval vplyv proxemiky na socialnú komunikáciu. % TODO remove
%Základným problémom je teda\ldots{} Najprv sa pozrieme na nejaké vysvetlenie ( % TODO remove
%Môže sa zdať, že problém vlastne nejestvuje\cite{Coplien:MPD}, ale bolo dokázané, že to tak nie je~\cite{Czarnecki:Staged, Czarnecki:Progress}. Napriek tomu, aj dnes na webe narazíme na všelijaké pochybné názory\cite{PLP-Framework}. Dôležité veci možno \emph{zdôrazniť kurzívou}. % TODO remove
Citácia vyzerá asi takto~\cite{Bicalho2020} % TODO remove
